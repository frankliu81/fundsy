...
RSpec.feature "UserSignups", type: :feature do
  describe "valid user data" do
    it "redirects to the home page, displays the user name and show flash message" do
      ...
      # using the launchy gem, Capybara will open up the current page in Chrome for us to examine
      save_and_open_page

      # valid_attributes and fill in methods in between
      ...
      # either with label (case sensivei) or the id of the input field
